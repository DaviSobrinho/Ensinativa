...
class ProfileFragmentAchievementsAdapter(private val context: Context, achievements: List<String>) : RecyclerView.Adapter<ProfileFragmentAchievementsAdapter.ViewHolder>() {
    private val tags = achievements.toMutableList()
