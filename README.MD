...
<div style="display: flex; justify-content: space-between; width: 800px; margin: 0 auto;">
  <h1 style="width: 200px; text-align: center;">Login Screen</h1>
  <h1 style="width: 200px; text-align: center;">Profile Screen</h1>
  <h1 style="width: 200px; text-align: center;">Home Screen</h1>
  <h1 style="width: 200px; text-align: center;">Messages Screen</h1>
</div>
